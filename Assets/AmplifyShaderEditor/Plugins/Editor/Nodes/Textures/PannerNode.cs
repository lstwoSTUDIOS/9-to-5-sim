...
namespace AmplifyShaderEditor
{
    ...
    public sealed class PannerNode : ParentNode
    {
            ...
            bool activateNode = true)
        {
            ...
            if (portId == 1) m_continuousPreviewRefresh = false;
        }

        public override void OnInputPortDisconnected(int portId)
        {
            base.OnInputPortDisconnected(portId);
            if (portId == 1) m_continuousPreviewRefresh = true;
        }
            ...
            bool ignoreLocalvar)
        {
            ...
            var timePort = m_inputPorts[2].GeneratePortInstructions(ref dataCollector);
            ...
            var speed = m_inputPorts[1].GeneratePortInstructions(ref dataCollector);
            var result = "( " + timePort + " * " + speed + " + " +
        ...
        public override void ReadFromString(ref string[] nodeParams)
        {
            ...
            if (UIUtils.CurrentShaderVersion() < 13107)
            {
                ...
                var speedX = Convert.ToSingle(GetCurrentParam(ref nodeParams));
                var speedY = Convert.ToSingle(GetCurrentParam(ref nodeParams));
